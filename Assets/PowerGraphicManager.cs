...
public class PowerGraphicManager : MonoBehaviour {
	...
	private void Update () {
		...
		if (currentIndex != 7 && GameManager.powerInLevel < 71 && GameManager.powerInLevel > 60) {
			currentIndex = 7;
			cells[0].GetComponent<Animator>().SetBool("Full", true);
			cells[1].GetComponent<Animator>().SetBool("Full", true);
			cells[2].GetComponent<Animator>().SetBool("Full", true);
			cells[3].GetComponent<Animator>().SetBool("Full", true);
			cells[4].GetComponent<Animator>().SetBool("Full", true);
			cells[5].GetComponent<Animator>().SetBool("Full", true);
